...
in layout(location = 7) mat3 ftbn;
...
{
    return texture(shadowTexture, shadowcoord.xy).x < shadowcoord.z - shadowBias ? 0.5 : 1.0;
}
...
void main()
{
	...
	for (int i = 0; i < numLights; i++)
	{
        ...
        vec3 normal = texture(normalTexture, ftexcoord).rgb; //or .xyz
